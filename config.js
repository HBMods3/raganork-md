...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/GGHmgYn.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: process.env.SESSION.trim() || 'Raganork~0901c0baad676e2743f23a831f5c69de:796a636553495943476a303d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f","deb80cd12ababea1c9b9a8ad6ce3fab2","78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Herbert;Suantak;0;https://i.imgur.com/GGHmgYn.jpeg;https://chat.whatsapp.com/IgV6un73n0J9TfzyVsaBRA',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"Herbert",
    BOT_NAME: process.env.BOT_NAME || 'HBWABot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Hetbert;HBWABot;https://i.imgur.com/GGHmgYn.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "918416093656",
